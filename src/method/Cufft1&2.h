...
class cufft1D
{
    public:
        ...
        ~cufft1D();
        void DestroyPlan();
        void CreateForwardPlan(int LineSize);   //rotate用的
        void ForwardFFT(float* PadLine);        //rotate用的
        void CreatePlan(int FFTSize, int num, int padsize, bool forward);  //rweight用的
