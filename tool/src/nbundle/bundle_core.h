...
private:
    ...
    void Process(std::vector<mx::pproj_params>& are_cam, float percent = 0);		//percent indicates the length threshold of tracks		0~1
...
public:
    static void BundleMain(util::TrackSpace& tspace_, int width_, int height_, std::vector<mx::pproj_params>& are_cam, std::vector<mx::pproj_params>* cameras, std::vector<v3_t>* points);
